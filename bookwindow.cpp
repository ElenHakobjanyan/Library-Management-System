...
BookWindow::BookWindow()
{
    ...
    model->setEditStrategy(QSqlTableModel::OnManualSubmit);// change
    ...
    mapper->addMapping(ui.yearEditFrom, model->fieldIndex("year"));
...
void BookWindow::about()
{
    QMessageBox::about(this, tr("About Project"),
            tr("<p>The <b>Library manager</b> course project 2024."));
}

void BookWindow::on_editModeCheckBox_clicked(bool checked)
{
    ui.add_btn->setEnabled(checked);
    ui.update_btn->setEnabled(checked);
    ui.delete_btn->setEnabled(checked);
}
